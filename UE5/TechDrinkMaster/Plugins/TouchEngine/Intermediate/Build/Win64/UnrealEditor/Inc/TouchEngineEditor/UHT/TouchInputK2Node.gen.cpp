...
#include "TouchEngineEditor/Private/Nodes/TouchInputK2Node.h"
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UTouchInputK2Node);
UClass* Z_Construct_UClass_UTouchInputK2Node_NoRegister()
{
	return UTouchInputK2Node::StaticClass();
}
...
template<> TOUCHENGINEEDITOR_API UClass* StaticClass<UTouchInputK2Node>()
{
	return UTouchInputK2Node::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngineEditor_Private_Nodes_TouchInputK2Node_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTouchInputK2Node, UTouchInputK2Node::StaticClass, TEXT("UTouchInputK2Node"), &Z_Registration_Info_UClass_UTouchInputK2Node, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTouchInputK2Node), 2494124274U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngineEditor_Private_Nodes_TouchInputK2Node_h_1548642145(TEXT("/Script/TouchEngineEditor"),
	Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngineEditor_Private_Nodes_TouchInputK2Node_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngineEditor_Private_Nodes_TouchInputK2Node_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
