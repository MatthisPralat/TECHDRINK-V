...
#include "TouchEngine/Public/Blueprint/TouchEngineActor.h"
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(ATouchEngineActor);
UClass* Z_Construct_UClass_ATouchEngineActor_NoRegister()
{
	return ATouchEngineActor::StaticClass();
}
struct Z_Construct_UClass_ATouchEngineActor_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_ATouchEngineActor_GetTouchEngineComponent, "GetTouchEngineComponent" }, // 663196710
	};
...
template<> TOUCHENGINE_API UClass* StaticClass<ATouchEngineActor>()
{
	return ATouchEngineActor::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngine_Public_Blueprint_TouchEngineActor_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATouchEngineActor, ATouchEngineActor::StaticClass, TEXT("ATouchEngineActor"), &Z_Registration_Info_UClass_ATouchEngineActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATouchEngineActor), 1840923254U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngine_Public_Blueprint_TouchEngineActor_h_1003685514(TEXT("/Script/TouchEngine"),
	Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngine_Public_Blueprint_TouchEngineActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngine_Public_Blueprint_TouchEngineActor_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
