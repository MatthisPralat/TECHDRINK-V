...
#include "TouchEngineEditor/Private/Factory/ToxAssetFactory.h"
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UToxAssetFactory);
UClass* Z_Construct_UClass_UToxAssetFactory_NoRegister()
{
	return UToxAssetFactory::StaticClass();
}
...
template<> TOUCHENGINEEDITOR_API UClass* StaticClass<UToxAssetFactory>()
{
	return UToxAssetFactory::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngineEditor_Private_Factory_ToxAssetFactory_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UToxAssetFactory, UToxAssetFactory::StaticClass, TEXT("UToxAssetFactory"), &Z_Registration_Info_UClass_UToxAssetFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UToxAssetFactory), 1525866107U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngineEditor_Private_Factory_ToxAssetFactory_h_2098150364(TEXT("/Script/TouchEngineEditor"),
	Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngineEditor_Private_Factory_ToxAssetFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngineEditor_Private_Factory_ToxAssetFactory_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
