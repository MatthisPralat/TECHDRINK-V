...
#include "TouchEngine/Public/Engine/ToxDelegateInfo.h"
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_ToxDelegateInfo;
class UScriptStruct* FToxDelegateInfo::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_ToxDelegateInfo.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_ToxDelegateInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FToxDelegateInfo, (UObject*)Z_Construct_UPackage__Script_TouchEngine(), TEXT("ToxDelegateInfo"));
	}
	return Z_Registration_Info_UScriptStruct_ToxDelegateInfo.OuterSingleton;
}
template<> TOUCHENGINE_API UScriptStruct* StaticStruct<FToxDelegateInfo>()
{
	return FToxDelegateInfo::StaticStruct();
}
...
{
	if (!Z_Registration_Info_UScriptStruct_ToxDelegateInfo.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_ToxDelegateInfo.InnerSingleton, Z_Construct_UScriptStruct_FToxDelegateInfo_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_ToxDelegateInfo.InnerSingleton;
}
// End ScriptStruct FToxDelegateInfo

// Begin Registration
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngine_Public_Engine_ToxDelegateInfo_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FToxDelegateInfo::StaticStruct, Z_Construct_UScriptStruct_FToxDelegateInfo_Statics::NewStructOps, TEXT("ToxDelegateInfo"), &Z_Registration_Info_UScriptStruct_ToxDelegateInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FToxDelegateInfo), 2660736054U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngine_Public_Engine_ToxDelegateInfo_h_4206039423(TEXT("/Script/TouchEngine"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngine_Public_Engine_ToxDelegateInfo_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngine_Public_Engine_ToxDelegateInfo_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
