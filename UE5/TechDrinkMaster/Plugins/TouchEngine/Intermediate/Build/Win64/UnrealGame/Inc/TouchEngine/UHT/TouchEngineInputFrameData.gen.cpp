...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_TouchEngineInputFrameData;
class UScriptStruct* FTouchEngineInputFrameData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_TouchEngineInputFrameData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_TouchEngineInputFrameData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTouchEngineInputFrameData, (UObject*)Z_Construct_UPackage__Script_TouchEngine(), TEXT("TouchEngineInputFrameData"));
	}
	return Z_Registration_Info_UScriptStruct_TouchEngineInputFrameData.OuterSingleton;
}
template<> TOUCHENGINE_API UScriptStruct* StaticStruct<FTouchEngineInputFrameData>()
{
	return FTouchEngineInputFrameData::StaticStruct();
}
...
{
	if (!Z_Registration_Info_UScriptStruct_TouchEngineInputFrameData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_TouchEngineInputFrameData.InnerSingleton, Z_Construct_UScriptStruct_FTouchEngineInputFrameData_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_TouchEngineInputFrameData.InnerSingleton;
}
// End ScriptStruct FTouchEngineInputFrameData

// Begin ScriptStruct FTouchEngineOutputFrameData
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_TouchEngineOutputFrameData;
class UScriptStruct* FTouchEngineOutputFrameData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_TouchEngineOutputFrameData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_TouchEngineOutputFrameData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTouchEngineOutputFrameData, (UObject*)Z_Construct_UPackage__Script_TouchEngine(), TEXT("TouchEngineOutputFrameData"));
	}
	return Z_Registration_Info_UScriptStruct_TouchEngineOutputFrameData.OuterSingleton;
}
template<> TOUCHENGINE_API UScriptStruct* StaticStruct<FTouchEngineOutputFrameData>()
{
	return FTouchEngineOutputFrameData::StaticStruct();
}
...
{
	if (!Z_Registration_Info_UScriptStruct_TouchEngineOutputFrameData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_TouchEngineOutputFrameData.InnerSingleton, Z_Construct_UScriptStruct_FTouchEngineOutputFrameData_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_TouchEngineOutputFrameData.InnerSingleton;
}
// End ScriptStruct FTouchEngineOutputFrameData

// Begin Registration
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngine_Public_Blueprint_TouchEngineInputFrameData_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FTouchEngineInputFrameData::StaticStruct, Z_Construct_UScriptStruct_FTouchEngineInputFrameData_Statics::NewStructOps, TEXT("TouchEngineInputFrameData"), &Z_Registration_Info_UScriptStruct_TouchEngineInputFrameData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTouchEngineInputFrameData), 58870914U) },
		{ FTouchEngineOutputFrameData::StaticStruct, Z_Construct_UScriptStruct_FTouchEngineOutputFrameData_Statics::NewStructOps, TEXT("TouchEngineOutputFrameData"), &Z_Registration_Info_UScriptStruct_TouchEngineOutputFrameData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTouchEngineOutputFrameData), 3091176733U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngine_Public_Blueprint_TouchEngineInputFrameData_h_3778343663(TEXT("/Script/TouchEngine"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngine_Public_Blueprint_TouchEngineInputFrameData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_TouchEngine_Source_TouchEngine_Public_Blueprint_TouchEngineInputFrameData_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
